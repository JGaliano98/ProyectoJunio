 ...
 */
class getEdificioRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EdificioRepository' shared autowired service.
     *
     * @return \App\Repository\EdificioRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EdificioRepository.php';

        return $container->privates['App\\Repository\\EdificioRepository'] = new \App\Repository\EdificioRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
