...
return [
    ...
    'actividad_delete' => [['id'], ['_controller' => 'App\\Controller\\API\\ActividadControllerAPI::deleteActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/actividades']], [], [], []],
    'detalle_actividad_delete' => [['id'], ['_controller' => 'App\\Controller\\API\\ActividadControllerAPI::deleteDetalleActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/detalleActividades']], [], [], []],
    ...
    'grupos_by_detalle_actividad' => [['id'], ['_controller' => 'App\\Controller\\API\\GrupoControllerAPI::grupos'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/grupos/detalle']], [], [], []],
    'ponente_index' => [['id'], ['id' => null, '_controller' => 'App\\Controller\\API\\PonenteControllerAPI::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/ponentes']], [], [], []],
    'ponentes_by_detalle_actividad' => [['id'], ['_controller' => 'App\\Controller\\API\\PonenteControllerAPI::getPonentesByDetalleActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/ponentes/detalle']], [], [], []],
    ...
    'descargar_pdf' => [['eventoId'], ['_controller' => 'App\\Controller\\PdfController::downloadPdf'], [], [['variable', '/', '[^/]++', 'eventoId', true], ['text', '/descargar-pdf']], [], [], []],
    'enviar_pdf' => [['eventoId', 'destinatario'], ['_controller' => 'App\\Controller\\PdfController::sendPdf'], [], [['variable', '/', '[^/]++', 'destinatario', true], ['variable', '/', '[^/]++', 'eventoId', true], ['text', '/enviar-pdf']], [], [], []],
    ...
    'not_found' => [['url'], ['_controller' => 'App\\Controller\\ErrorController::notFound'], ['url' => '.+'], [['variable', '/', '.+', 'url', true]], [], [], []],
    ...
    'App\Controller\API\ActividadControllerAPI::deleteActividad' => [['id'], ['_controller' => 'App\\Controller\\API\\ActividadControllerAPI::deleteActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/actividades']], [], [], []],
    'App\Controller\API\ActividadControllerAPI::deleteDetalleActividad' => [['id'], ['_controller' => 'App\\Controller\\API\\ActividadControllerAPI::deleteDetalleActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/detalleActividades']], [], [], []],
    ...
    'App\Controller\API\GrupoControllerAPI::grupos' => [['id'], ['_controller' => 'App\\Controller\\API\\GrupoControllerAPI::grupos'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/grupos/detalle']], [], [], []],
    'App\Controller\API\PonenteControllerAPI::index' => [['id'], ['id' => null, '_controller' => 'App\\Controller\\API\\PonenteControllerAPI::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/ponentes']], [], [], []],
    'App\Controller\API\PonenteControllerAPI::getPonentesByDetalleActividad' => [['id'], ['_controller' => 'App\\Controller\\API\\PonenteControllerAPI::getPonentesByDetalleActividad'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/API/ponentes/detalle']], [], [], []],
    ...
    'App\Controller\PdfController::downloadPdf' => [['eventoId'], ['_controller' => 'App\\Controller\\PdfController::downloadPdf'], [], [['variable', '/', '[^/]++', 'eventoId', true], ['text', '/descargar-pdf']], [], [], []],
    'App\Controller\PdfController::sendPdf' => [['eventoId', 'destinatario'], ['_controller' => 'App\\Controller\\PdfController::sendPdf'], [], [['variable', '/', '[^/]++', 'destinatario', true], ['variable', '/', '[^/]++', 'eventoId', true], ['text', '/enviar-pdf']], [], [], []],
