 ...
 */
class getNivelEducativoRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NivelEducativoRepository' shared autowired service.
     *
     * @return \App\Repository\NivelEducativoRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NivelEducativoRepository.php';

        return $container->privates['App\\Repository\\NivelEducativoRepository'] = new \App\Repository\NivelEducativoRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
