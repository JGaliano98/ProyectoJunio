 ...
 */
class getPonenteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PonenteRepository' shared autowired service.
     *
     * @return \App\Repository\PonenteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PonenteRepository.php';

        return $container->privates['App\\Repository\\PonenteRepository'] = new \App\Repository\PonenteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
