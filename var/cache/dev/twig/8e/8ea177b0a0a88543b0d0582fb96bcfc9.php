...
class __TwigTemplate_c90c14e610afb36af961f35410f30a16 extends Template
{
    ...
    <div class=\"container\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["eventos"]) || array_key_exists("eventos", $context) ? $context["eventos"] : (function () { throw new RuntimeError('Variable "eventos" does not exist.', 13, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["evento"]) {
            ...
            yield "            <div class=\"col-md-4 mb-4\">
                <div class=\"card\">
                    <img src=\"images/";
            // line 16
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["evento"], "imagenUrl", [], "any", false, false, false, 16), "html", null, true);
            yield "\" class=\"card-img-top\" alt=\"Imagen del evento\">
                    <div class=\"card-body\">
                        <h5 class=\"card-title\">";
            // line 18
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["evento"], "titulo", [], "any", false, false, false, 18), "html", null, true);
            yield "</h5>
                        <a href=\"";
            // line 19
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("descargar_pdf", ["eventoId" => CoreExtension::getAttribute($this->env, $this->source, $context["evento"], "id", [], "any", false, false, false, 19)]), "html", null, true);
    ...
    {
        return array (  129 => 39,  125 => 37,  110 => 24,  99 => 19,  95 => 18,  90 => 16,  86 => 14,  82 => 13,  69 => 4,  59 => 3,  36 => 1,);
    }
