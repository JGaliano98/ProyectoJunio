...
class __TwigTemplate_ca35f53f5e25a4580c991189507c180c extends Template
{
    private $source;
    private $macros = [];
...
<body>
    <div class=\"header\">
        <img src=\"";
        // line 43
        yield Twig\Extension\EscaperExtension::escape($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("images/fernandito.jpg")), "html", null, true);
        yield "\" alt=\"Logo\" class=\"logo\">
    </div>
    <div class=\"content\">
        <h1>";
        // line 46
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 46, $this->source); })()), "html", null, true);
        yield "</h1>
    ...
    <div class=\"footer\">
        ...
        // line 50
        yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::dateFormatFilter($this->env, "now", "Y-m-d H:i:s"), "html", null, true);
        yield "
    </div>
</body>
</html>
