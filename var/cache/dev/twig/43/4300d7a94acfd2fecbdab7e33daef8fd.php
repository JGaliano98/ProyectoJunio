...
class __TwigTemplate_f64347757681bef59828facc067d74de extends Template
{
    private $source;
    private $macros = [];
...
<body>
    <div class=\"message\">
        ...
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["destinatario"]) || array_key_exists("destinatario", $context) ? $context["destinatario"] : (function () { throw new RuntimeError('Variable "destinatario" does not exist.', 12, $this->source); })()), "html", null, true);
        yield "</strong>.</p>
    </div>
</body>
</html>";
