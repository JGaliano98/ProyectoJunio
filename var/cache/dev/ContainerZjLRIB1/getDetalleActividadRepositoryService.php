 ...
 */
class getDetalleActividadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DetalleActividadRepository' shared autowired service.
     *
     * @return \App\Repository\DetalleActividadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DetalleActividadRepository.php';

        return $container->privates['App\\Repository\\DetalleActividadRepository'] = new \App\Repository\DetalleActividadRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
