...
class getActividadRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActividadRepository.php';

        return $container->privates['App\\Repository\\ActividadRepository'] = new \App\Repository\ActividadRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
