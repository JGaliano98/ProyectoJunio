 ...
 */
class getVichUploader_Listener_Clean_EventImageService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.event_image'])) {
            return $container->privates['vich_uploader.listener.clean.event_image'];
        }

        return $container->privates['vich_uploader.listener.clean.event_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('event_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
